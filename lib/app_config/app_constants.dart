...
class Constants {
  ...
  static String internetErrorMessage = "Please check your Internet Connection and try again!";
  static String apiErrorMessage = "Error in Data sync! Please contact PropEdge administrator!";
  static String apiSuccessMessage = "Data synced Successfully.";
  static String noDataSyncErrorMessage = "No data found to sync!";
  static String checkInternetMsg = "No internet connection detected. Please check your network.";
  static String downloadMsg = "Download Live data to Local?";
  static String limitExistsErrorMessage = "Please delete old image before upload new location map";
  static String finalFormAlertText = "Please review your forms before final submission because once you submit, you won't be able to edit the form.";
