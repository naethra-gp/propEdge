...
import 'new/cell_form_field.dart';

class StageCalculatorWidget extends StatefulWidget {
  final VoidCallback buttonSubmitted;
  final String propId;
  const StageCalculatorWidget({
    super.key,
  ...
  @override
  State<StageCalculatorWidget> createState() => _StageCalculatorWidgetState();
}

class _StageCalculatorWidgetState extends State<StageCalculatorWidget> {
  List calDetails = [];
  List headerDetails = [];
                              ...
                              for (int i = 0; i < headerRows.length; i++) ...[
                                TableCell(
                                  child: Padding(
                                    ...
                                    child: Text(headerRows[i].toString(), style: TextStyle(color:Colors.blue),),
                                  ),
                                ),
                              ],
                            ],
                                ...
                                TableCell(
                                  child: Padding(
                                    ...
                                    child: CellFormField(
                                      ...
                                      onChanged: (value) {
                                        setState(() {
                                          progressColumn[i] = removeLeadingZeros(value);
                                          progressControllers[i].text = removeLeadingZeros(value);
                                        });
                                ...
                                TableCell(
                                  child: Padding(
                                    ...
                                    child: CellFormField(
                                      ...
                                      onChanged: (value) {
                                        setState(() {
                                          recommendedColumn[i] = removeLeadingZeros(value);
                                          recommendControllers[i].text = removeLeadingZeros(value);
                                        });
                                ...
                                TableCell(
                                  child: Padding(
                                    ...
                                    child: CellFormField(
                                      ...
                                      onChanged: (value) {
                                        setState(() {
                                          totalFloorColumn[i] = removeLeadingZeros(value);
                                          totalFloorControllers[i].text = removeLeadingZeros(value);
                                        });
                                ...
                                TableCell(
                                  child: Padding(
                                    ...
                                    child: CellFormField(
                                      ...
                                      readOnly: i == completedFloorControllers.length - 1,
                                      fillColor: Colors.blue[100],
                                      onChanged: (String value) {
                                        setState(() {
                                          completedFloorColumn[i] = removeLeadingZeros(value);
                                          completedFloorControllers[i].text = removeLeadingZeros(value);
                                        });
                                      ...
                                      onFieldSubmitted: (value) {
                                        if (completedFloorColumn[i].toString() == "") {
                                          completedFloorColumn[i] = 0;
                                          completedFloorControllers[i].text = "0";
                                          FocusScope.of(context).unfocus();
                                          setState(() {});
                                        }
                                      },
