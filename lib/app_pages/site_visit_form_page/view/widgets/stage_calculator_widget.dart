...
class StageCalculatorViewWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List progressPerAsPerPolicy =
        jsonDecode(details[0]['ProgressPerAsPerPolicy']);
    List recommendedPerAsPerPolicy =
        jsonDecode(details[0]['RecommendedPerAsPerPolicy']);
                            ...
                            children: [
                              ...
                              TableCell(
                                child: Padding(
                                  ...
                                  child:
                                      tableCell(progressColumn[i].toString()),
                                ),
                              ),
                              ...
                              TableCell(
                                child: Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child:
                                      tableCell(totalFloorColumn[i].toString()),
                                ),
                              ),
                              ...
                              TableCell(
                                child: Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: tableCell(
                                      completedFloorColumn[i].toString()),
                                ),
                              ),
                              ...
                              TableCell(
                                child: Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: tableCell(
                                      recommendedPerColumn[i].toString()),
                                ),
                              ),
                              ...
                              TableCell(
                                child: Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: tableCell(
                                      progressPerAsPerPolicy[i].toString()),
                                ),
                              ),
                              ...
                              TableCell(
                                child: Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: tableCell(
                                      recommendedPerAsPerPolicy[i].toString()),
                                ),
                              ),
                            ],
                          ),
